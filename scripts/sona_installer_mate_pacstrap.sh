...
pacstrap /mnt base efibootmgr espeakup grub lightdm lightdm-gtk-greeter linux linux-firmware mate mate-extra network-manager-applet networkmanager orca os-prober speech-dispatcher sudo xdg-user-dirs xdg-utils
